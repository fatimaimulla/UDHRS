...
interface Medicine {
  ...
  frequency: string;
  days: number;
  summary?: string; // ✅ AI summary field
}
...
const processVoiceTranscript = async (
  ...
  const medicines = result.medicine.map((name: string, i: number) => ({
    ...
    summary: result.summary?.[i] || "", // ✅ add AI-powered summary
  }));
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Speak your prescription details and we'll convert them to structured
            form
          </CardDescription>
        </CardHeader>
            ...
            <div className="space-y-3">
              ...
              {transcript && (
                <div>
                  ...
                  <p className="text-sm bg-accent/20 p-3 rounded-lg italic">
                    {transcript}
                  </p>
                </div>
              )}
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2 text-sm text-muted-foreground">
            <p>
              <strong>Example:</strong> "Prescribe paracetamol 500mg twice daily
              for 5 days, and ibuprofen 400mg three times daily for 3 days"
            </p>
            <p>
              <strong>Tips:</strong>
            </p>
            <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <li>
                Use terms like "twice daily", "three times daily", "once daily"
              </li>
