...
import { Search, FileText, History, LogOut, Stethoscope, Users, Calendar, Activity, Menu, X } from "lucide-react"
        ...
        <div className="flex h-16 items-center justify-between px-4 lg:px-6">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-foreground hidden sm:inline">HealthRecord Pro</span>
              <span className="text-lg font-bold text-foreground sm:hidden">HRP</span>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <div className="text-right">
              <p className="text-sm font-medium text-foreground">{doctorData.name}</p>
              <p className="text-xs text-muted-foreground">{doctorData.specialization}</p>
            </div>
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-4 lg:p-6 max-w-full overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <Card className="hover:shadow-md transition-shadow">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">2 completed, 6 pending</p>
                  </CardContent>
                </Card>
          ...
          {activeTab === "find-patient" && (
            <div className="space-y-6">
              <div>
                <h1 className="text-2xl lg:text-3xl font-bold text-foreground">Find Patient</h1>
                <p className="text-muted-foreground">Search for patients by ID or name</p>
              </div>
              <PatientSearch
          ...
          {activeTab === "prescription" && (
            <div className="space-y-6">
              <div>
                <h1 className="text-2xl lg:text-3xl font-bold text-foreground">Create Prescription</h1>
                <p className="text-muted-foreground">Create new prescriptions with manual entry or voice input</p>
              </div>
              <PrescriptionForm 
...
/>
          ...
          {activeTab === "history" && (
            <div className="space-y-6">
              <div>
                <h1 className="text-2xl lg:text-3xl font-bold text-foreground">Patient History</h1>
                <p className="text-muted-foreground">View previous prescriptions and patient records</p>
              </div>
              <PatientHistory />
            </div>
          )}
